#ifndef CAS_TEST_SEDOV___SEDOVSERVICEMACROS_H
#define CAS_TEST_SEDOV___SEDOVSERVICEMACROS_H
...
std::shared_ptr<SedovInitMatMonoExecutionContext> ctx(new SedovInitMatMonoExecutionContext("InitMatMonoExecutionContext", dim));\
...
std::shared_ptr<SedovInitVarMonoExecutionContext> ctx(new SedovInitVarMonoExecutionContext("InitVarMonoExecutionContext", dim));\
...
std::shared_ptr<SedovInitMatExecutionContext> ctx(new SedovInitMatExecutionContext("InitMatExecutionContext", dim));\
...
std::shared_ptr<SedovInitVarExecutionContext> ctx(new SedovInitVarExecutionContext("InitVarExecutionContext", dim));\
...
#endif // CAS_TEST_SEDOV___SEDOVSERVICEMACROS_H
