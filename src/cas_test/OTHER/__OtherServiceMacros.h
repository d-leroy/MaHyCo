#ifndef CAS_TEST_OTHER___OTHERSERVICEMACROS_H
#define CAS_TEST_OTHER___OTHERSERVICEMACROS_H
...
std::shared_ptr<OtherInitMatExecutionContext> ctx(new OtherInitMatExecutionContext("InitMatExecutionContext", dim));\
...
std::shared_ptr<OtherInitVarExecutionContext> ctx(new OtherInitVarExecutionContext("InitVarExecutionContext", dim));\
...
#endif // CAS_TEST_OTHER___OTHERSERVICEMACROS_H
