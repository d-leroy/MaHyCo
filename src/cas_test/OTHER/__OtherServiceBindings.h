...
void bind_cas_test_other_other(py::module __attribute__((unused)) &m)
{
  ...
  pybind11::class_<Cas_testOTHER::OtherInitMatExecutionContext, std::shared_ptr<Cas_testOTHER::OtherInitMatExecutionContext>, SciHook::SciHookExecutionContext>(sub_cas_test_other_other, "OtherInitMatExecutionContext")
    ...
    .def_property_readonly("cell_coord", &Cas_testOTHER::OtherInitMatExecutionContext::get_m_cell_coord)
    .def_property_readonly("materiau", &Cas_testOTHER::OtherInitMatExecutionContext::get_m_materiau)
  ...
  pybind11::class_<Cas_testOTHER::OtherInitVarExecutionContext, std::shared_ptr<Cas_testOTHER::OtherInitVarExecutionContext>, SciHook::SciHookExecutionContext>(sub_cas_test_other_other, "OtherInitVarExecutionContext")
    ...
    .def_property_readonly("cell_coord", &Cas_testOTHER::OtherInitVarExecutionContext::get_m_cell_coord)
    .def_property_readonly("pseudo_viscosity", &Cas_testOTHER::OtherInitVarExecutionContext::get_m_pseudo_viscosity)
    .def_property_readonly("density", &Cas_testOTHER::OtherInitVarExecutionContext::get_m_density)
    .def_property_readonly("pressure", &Cas_testOTHER::OtherInitVarExecutionContext::get_m_pressure)
    .def_property_readonly("internal_energy", &Cas_testOTHER::OtherInitVarExecutionContext::get_m_internal_energy)
    .def_property_readonly("fracvol", &Cas_testOTHER::OtherInitVarExecutionContext::get_m_fracvol)
    .def_property_readonly("mass_fraction", &Cas_testOTHER::OtherInitVarExecutionContext::get_m_mass_fraction)
    .def_property_readonly("velocity_n", &Cas_testOTHER::OtherInitVarExecutionContext::get_m_velocity_n)
    .def_property_readonly("velocity", &Cas_testOTHER::OtherInitVarExecutionContext::get_m_velocity)
