...
void bind_cas_test_rider_rider(py::module __attribute__((unused)) &m)
{
  ...
  pybind11::class_<Cas_testRIDER::RiderInitMatMonoExecutionContext, std::shared_ptr<Cas_testRIDER::RiderInitMatMonoExecutionContext>, SciHook::SciHookExecutionContext>(sub_cas_test_rider_rider, "RiderInitMatMonoExecutionContext")
    ...
    .def_property_readonly("materiau", &Cas_testRIDER::RiderInitMatMonoExecutionContext::get_materiau)
  ...
  pybind11::class_<Cas_testRIDER::RiderInitVarMonoExecutionContext, std::shared_ptr<Cas_testRIDER::RiderInitVarMonoExecutionContext>, SciHook::SciHookExecutionContext>(sub_cas_test_rider_rider, "RiderInitVarMonoExecutionContext")
    ...
    .def_property_readonly("node_coord", &Cas_testRIDER::RiderInitVarMonoExecutionContext::get_node_coord)
    .def_property_readonly("pseudo_viscosity", &Cas_testRIDER::RiderInitVarMonoExecutionContext::get_pseudo_viscosity)
    .def_property_readonly("density", &Cas_testRIDER::RiderInitVarMonoExecutionContext::get_density)
    .def_property_readonly("pressure", &Cas_testRIDER::RiderInitVarMonoExecutionContext::get_pressure)
    .def_property_readonly("fracvol", &Cas_testRIDER::RiderInitVarMonoExecutionContext::get_fracvol)
    .def_property_readonly("mass_fraction", &Cas_testRIDER::RiderInitVarMonoExecutionContext::get_mass_fraction)
    .def_property_readonly("velocity_n", &Cas_testRIDER::RiderInitVarMonoExecutionContext::get_velocity_n)
    .def_property_readonly("velocity", &Cas_testRIDER::RiderInitVarMonoExecutionContext::get_velocity)
  ...
  pybind11::class_<Cas_testRIDER::RiderInitMatExecutionContext, std::shared_ptr<Cas_testRIDER::RiderInitMatExecutionContext>, SciHook::SciHookExecutionContext>(sub_cas_test_rider_rider, "RiderInitMatExecutionContext")
    ...
    .def_property_readonly("node_coord", &Cas_testRIDER::RiderInitMatExecutionContext::get_node_coord)
    .def_property_readonly("materiau", &Cas_testRIDER::RiderInitMatExecutionContext::get_materiau)
  ...
  pybind11::class_<Cas_testRIDER::RiderInitVarExecutionContext, std::shared_ptr<Cas_testRIDER::RiderInitVarExecutionContext>, SciHook::SciHookExecutionContext>(sub_cas_test_rider_rider, "RiderInitVarExecutionContext")
    ...
    .def_property_readonly("node_coord", &Cas_testRIDER::RiderInitVarExecutionContext::get_node_coord)
    .def_property_readonly("pseudo_viscosity", &Cas_testRIDER::RiderInitVarExecutionContext::get_pseudo_viscosity)
    .def_property_readonly("density", &Cas_testRIDER::RiderInitVarExecutionContext::get_density)
    .def_property_readonly("pressure", &Cas_testRIDER::RiderInitVarExecutionContext::get_pressure)
    .def_property_readonly("fracvol", &Cas_testRIDER::RiderInitVarExecutionContext::get_fracvol)
    .def_property_readonly("mass_fraction", &Cas_testRIDER::RiderInitVarExecutionContext::get_mass_fraction)
    .def_property_readonly("velocity_n", &Cas_testRIDER::RiderInitVarExecutionContext::get_velocity_n)
    .def_property_readonly("velocity", &Cas_testRIDER::RiderInitVarExecutionContext::get_velocity)
