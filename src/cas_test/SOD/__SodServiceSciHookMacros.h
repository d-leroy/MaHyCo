...
#define SCIHOOK_TRIGGER_CAS_TEST_SOD_SOD_INITMATMONO_BEFORE \
...
#define SCIHOOK_TRIGGER_CAS_TEST_SOD_SOD_INITMATMONO_AFTER SciHook::trigger(INITMATMONO_AFTER, ctx);
#else
#define SCIHOOK_TRIGGER_CAS_TEST_SOD_SOD_INITMATMONO_BEFORE
#define SCIHOOK_TRIGGER_CAS_TEST_SOD_SOD_INITMATMONO_AFTER
#endif
...
#define SCIHOOK_TRIGGER_CAS_TEST_SOD_SOD_INITVARMONO_BEFORE \
...
#define SCIHOOK_TRIGGER_CAS_TEST_SOD_SOD_INITVARMONO_AFTER SciHook::trigger(INITVARMONO_AFTER, ctx);
#else
#define SCIHOOK_TRIGGER_CAS_TEST_SOD_SOD_INITVARMONO_BEFORE
#define SCIHOOK_TRIGGER_CAS_TEST_SOD_SOD_INITVARMONO_AFTER
#endif
...
#define SCIHOOK_TRIGGER_CAS_TEST_SOD_SOD_INITMAT_BEFORE \
...
#define SCIHOOK_TRIGGER_CAS_TEST_SOD_SOD_INITMAT_AFTER SciHook::trigger(INITMAT_AFTER, ctx);
#else
#define SCIHOOK_TRIGGER_CAS_TEST_SOD_SOD_INITMAT_BEFORE
#define SCIHOOK_TRIGGER_CAS_TEST_SOD_SOD_INITMAT_AFTER
#endif
...
#define SCIHOOK_TRIGGER_CAS_TEST_SOD_SOD_INITVAR_BEFORE \
...
#define SCIHOOK_TRIGGER_CAS_TEST_SOD_SOD_INITVAR_AFTER SciHook::trigger(INITVAR_AFTER, ctx);
#else
#define SCIHOOK_TRIGGER_CAS_TEST_SOD_SOD_INITVAR_BEFORE
#define SCIHOOK_TRIGGER_CAS_TEST_SOD_SOD_INITVAR_AFTER
#endif
