...
void bind_cas_test_sod_sod(py::module __attribute__((unused)) &m)
{
  ...
  pybind11::class_<Cas_testSOD::SodInitMatMonoExecutionContext, std::shared_ptr<Cas_testSOD::SodInitMatMonoExecutionContext>, SciHook::SciHookExecutionContext>(sub_cas_test_sod_sod, "SodInitMatMonoExecutionContext")
    ...
    .def_property_readonly("materiau", &Cas_testSOD::SodInitMatMonoExecutionContext::get_m_materiau)
  ...
  pybind11::class_<Cas_testSOD::SodInitVarMonoExecutionContext, std::shared_ptr<Cas_testSOD::SodInitVarMonoExecutionContext>, SciHook::SciHookExecutionContext>(sub_cas_test_sod_sod, "SodInitVarMonoExecutionContext")
    ...
    .def_property_readonly("cell_coord", &Cas_testSOD::SodInitVarMonoExecutionContext::get_m_cell_coord)
    .def_property_readonly("density", &Cas_testSOD::SodInitVarMonoExecutionContext::get_m_density)
    .def_property_readonly("pressure", &Cas_testSOD::SodInitVarMonoExecutionContext::get_m_pressure)
    .def_property_readonly("fracvol", &Cas_testSOD::SodInitVarMonoExecutionContext::get_m_fracvol)
    .def_property_readonly("mass_fraction", &Cas_testSOD::SodInitVarMonoExecutionContext::get_m_mass_fraction)
    .def_property_readonly("velocity", &Cas_testSOD::SodInitVarMonoExecutionContext::get_m_velocity)
  ...
  pybind11::class_<Cas_testSOD::SodInitMatExecutionContext, std::shared_ptr<Cas_testSOD::SodInitMatExecutionContext>, SciHook::SciHookExecutionContext>(sub_cas_test_sod_sod, "SodInitMatExecutionContext")
    ...
    .def_property_readonly("cell_coord", &Cas_testSOD::SodInitMatExecutionContext::get_m_cell_coord)
    .def_property_readonly("materiau", &Cas_testSOD::SodInitMatExecutionContext::get_m_materiau)
  ...
  pybind11::class_<Cas_testSOD::SodInitVarExecutionContext, std::shared_ptr<Cas_testSOD::SodInitVarExecutionContext>, SciHook::SciHookExecutionContext>(sub_cas_test_sod_sod, "SodInitVarExecutionContext")
    ...
    .def_property_readonly("cell_coord", &Cas_testSOD::SodInitVarExecutionContext::get_m_cell_coord)
    .def_property_readonly("density", &Cas_testSOD::SodInitVarExecutionContext::get_m_density)
    .def_property_readonly("pressure", &Cas_testSOD::SodInitVarExecutionContext::get_m_pressure)
    .def_property_readonly("fracvol", &Cas_testSOD::SodInitVarExecutionContext::get_m_fracvol)
    .def_property_readonly("mass_fraction", &Cas_testSOD::SodInitVarExecutionContext::get_m_mass_fraction)
    .def_property_readonly("velocity", &Cas_testSOD::SodInitVarExecutionContext::get_m_velocity)
