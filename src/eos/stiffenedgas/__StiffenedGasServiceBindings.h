...
void bind_eos_stiffenedgas_stiffenedgas(py::module __attribute__((unused)) &m)
{
  ...
  pybind11::class_<EosStiffenedgas::StiffenedGasInitEOSExecutionContext, std::shared_ptr<EosStiffenedgas::StiffenedGasInitEOSExecutionContext>, SciHook::SciHookExecutionContext>(sub_eos_stiffenedgas_stiffenedgas, "StiffenedGasInitEOSExecutionContext")
    ...
    .def_property_readonly("pressure", &EosStiffenedgas::StiffenedGasInitEOSExecutionContext::get_pressure)
    .def_property_readonly("density", &EosStiffenedgas::StiffenedGasInitEOSExecutionContext::get_density)
    .def_property_readonly("internal_energy", &EosStiffenedgas::StiffenedGasInitEOSExecutionContext::get_internal_energy)
    .def_property_readonly("sound_speed", &EosStiffenedgas::StiffenedGasInitEOSExecutionContext::get_sound_speed)
  ...
  pybind11::class_<EosStiffenedgas::StiffenedGasApplyEOSExecutionContext, std::shared_ptr<EosStiffenedgas::StiffenedGasApplyEOSExecutionContext>, SciHook::SciHookExecutionContext>(sub_eos_stiffenedgas_stiffenedgas, "StiffenedGasApplyEOSExecutionContext")
    ...
    .def_property_readonly("internal_energy", &EosStiffenedgas::StiffenedGasApplyEOSExecutionContext::get_internal_energy)
    .def_property_readonly("density", &EosStiffenedgas::StiffenedGasApplyEOSExecutionContext::get_density)
    .def_property_readonly("pressure", &EosStiffenedgas::StiffenedGasApplyEOSExecutionContext::get_pressure)
    .def_property_readonly("sound_speed", &EosStiffenedgas::StiffenedGasApplyEOSExecutionContext::get_sound_speed)
    .def_property_readonly("dpde", &EosStiffenedgas::StiffenedGasApplyEOSExecutionContext::get_dpde)
  ...
  pybind11::class_<EosStiffenedgas::StiffenedGasApplyOneCellEOSExecutionContext, std::shared_ptr<EosStiffenedgas::StiffenedGasApplyOneCellEOSExecutionContext>, SciHook::SciHookExecutionContext>(sub_eos_stiffenedgas_stiffenedgas, "StiffenedGasApplyOneCellEOSExecutionContext")
    ...
    .def_property_readonly("internal_energy", &EosStiffenedgas::StiffenedGasApplyOneCellEOSExecutionContext::get_internal_energy)
    .def_property_readonly("density", &EosStiffenedgas::StiffenedGasApplyOneCellEOSExecutionContext::get_density)
    .def_property_readonly("pressure", &EosStiffenedgas::StiffenedGasApplyOneCellEOSExecutionContext::get_pressure)
    .def_property_readonly("sound_speed", &EosStiffenedgas::StiffenedGasApplyOneCellEOSExecutionContext::get_sound_speed)
    .def_property_readonly("dpde", &EosStiffenedgas::StiffenedGasApplyOneCellEOSExecutionContext::get_dpde)
