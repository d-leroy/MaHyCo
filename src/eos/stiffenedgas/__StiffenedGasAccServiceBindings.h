...
void bind_eos_stiffenedgas_stiffenedgasacc(py::module __attribute__((unused)) &m)
{
  ...
  pybind11::class_<EosStiffenedgas::StiffenedGasAccApplyEOSWithSupportExecutionContext, std::shared_ptr<EosStiffenedgas::StiffenedGasAccApplyEOSWithSupportExecutionContext>, SciHook::SciHookExecutionContext>(sub_eos_stiffenedgas_stiffenedgasacc, "StiffenedGasAccApplyEOSWithSupportExecutionContext")
    ...
    .def_property_readonly("internal_energy", &EosStiffenedgas::StiffenedGasAccApplyEOSWithSupportExecutionContext::get_m_internal_energy)
    .def_property_readonly("density", &EosStiffenedgas::StiffenedGasAccApplyEOSWithSupportExecutionContext::get_m_density)
    .def_property_readonly("tension_limit_cst", &EosStiffenedgas::StiffenedGasAccApplyEOSWithSupportExecutionContext::get_m_tension_limit_cst)
    .def_property_readonly("adiabatic_cst", &EosStiffenedgas::StiffenedGasAccApplyEOSWithSupportExecutionContext::get_m_adiabatic_cst)
    .def_property_readonly("pressure", &EosStiffenedgas::StiffenedGasAccApplyEOSWithSupportExecutionContext::get_m_pressure)
    .def_property_readonly("sound_speed", &EosStiffenedgas::StiffenedGasAccApplyEOSWithSupportExecutionContext::get_m_sound_speed)
    .def_property_readonly("dpde", &EosStiffenedgas::StiffenedGasAccApplyEOSWithSupportExecutionContext::get_m_dpde)
  ...
  pybind11::class_<EosStiffenedgas::StiffenedGasAccInitEOSExecutionContext, std::shared_ptr<EosStiffenedgas::StiffenedGasAccInitEOSExecutionContext>, SciHook::SciHookExecutionContext>(sub_eos_stiffenedgas_stiffenedgasacc, "StiffenedGasAccInitEOSExecutionContext")
    ...
    .def_property_readonly("pressure", &EosStiffenedgas::StiffenedGasAccInitEOSExecutionContext::get_m_pressure)
    .def_property_readonly("density", &EosStiffenedgas::StiffenedGasAccInitEOSExecutionContext::get_m_density)
    .def_property_readonly("internal_energy", &EosStiffenedgas::StiffenedGasAccInitEOSExecutionContext::get_m_internal_energy)
    .def_property_readonly("sound_speed", &EosStiffenedgas::StiffenedGasAccInitEOSExecutionContext::get_m_sound_speed)
  ...
  pybind11::class_<EosStiffenedgas::StiffenedGasAccApplyOneCellEOSExecutionContext, std::shared_ptr<EosStiffenedgas::StiffenedGasAccApplyOneCellEOSExecutionContext>, SciHook::SciHookExecutionContext>(sub_eos_stiffenedgas_stiffenedgasacc, "StiffenedGasAccApplyOneCellEOSExecutionContext")
    ...
    .def_property_readonly("internal_energy", &EosStiffenedgas::StiffenedGasAccApplyOneCellEOSExecutionContext::get_m_internal_energy)
    .def_property_readonly("density", &EosStiffenedgas::StiffenedGasAccApplyOneCellEOSExecutionContext::get_m_density)
    .def_property_readonly("pressure", &EosStiffenedgas::StiffenedGasAccApplyOneCellEOSExecutionContext::get_m_pressure)
    .def_property_readonly("sound_speed", &EosStiffenedgas::StiffenedGasAccApplyOneCellEOSExecutionContext::get_m_sound_speed)
    .def_property_readonly("dpde", &EosStiffenedgas::StiffenedGasAccApplyOneCellEOSExecutionContext::get_m_dpde)
