...
void bind_eos_perfectgas_perfectgasaccwithsupport(py::module __attribute__((unused)) &m)
{
  ...
  pybind11::class_<EosPerfectgas::PerfectGasAccWithSupportApplyEOSWithSupportExecutionContext, std::shared_ptr<EosPerfectgas::PerfectGasAccWithSupportApplyEOSWithSupportExecutionContext>, SciHook::SciHookExecutionContext>(sub_eos_perfectgas_perfectgasaccwithsupport, "PerfectGasAccWithSupportApplyEOSWithSupportExecutionContext")
    ...
    .def_property_readonly("density", &EosPerfectgas::PerfectGasAccWithSupportApplyEOSWithSupportExecutionContext::get_m_density)
    .def_property_readonly("internal_energy", &EosPerfectgas::PerfectGasAccWithSupportApplyEOSWithSupportExecutionContext::get_m_internal_energy)
    .def_property_readonly("adiabatic_cst", &EosPerfectgas::PerfectGasAccWithSupportApplyEOSWithSupportExecutionContext::get_m_adiabatic_cst)
    .def_property_readonly("pressure", &EosPerfectgas::PerfectGasAccWithSupportApplyEOSWithSupportExecutionContext::get_m_pressure)
    .def_property_readonly("sound_speed", &EosPerfectgas::PerfectGasAccWithSupportApplyEOSWithSupportExecutionContext::get_m_sound_speed)
    .def_property_readonly("dpde", &EosPerfectgas::PerfectGasAccWithSupportApplyEOSWithSupportExecutionContext::get_m_dpde)
  ...
  pybind11::class_<EosPerfectgas::PerfectGasAccWithSupportInitEOSExecutionContext, std::shared_ptr<EosPerfectgas::PerfectGasAccWithSupportInitEOSExecutionContext>, SciHook::SciHookExecutionContext>(sub_eos_perfectgas_perfectgasaccwithsupport, "PerfectGasAccWithSupportInitEOSExecutionContext")
    ...
    .def_property_readonly("pressure", &EosPerfectgas::PerfectGasAccWithSupportInitEOSExecutionContext::get_m_pressure)
    .def_property_readonly("density", &EosPerfectgas::PerfectGasAccWithSupportInitEOSExecutionContext::get_m_density)
    .def_property_readonly("internal_energy", &EosPerfectgas::PerfectGasAccWithSupportInitEOSExecutionContext::get_m_internal_energy)
    .def_property_readonly("sound_speed", &EosPerfectgas::PerfectGasAccWithSupportInitEOSExecutionContext::get_m_sound_speed)
  ...
  pybind11::class_<EosPerfectgas::PerfectGasAccWithSupportApplyOneCellEOSExecutionContext, std::shared_ptr<EosPerfectgas::PerfectGasAccWithSupportApplyOneCellEOSExecutionContext>, SciHook::SciHookExecutionContext>(sub_eos_perfectgas_perfectgasaccwithsupport, "PerfectGasAccWithSupportApplyOneCellEOSExecutionContext")
    ...
    .def_property_readonly("density", &EosPerfectgas::PerfectGasAccWithSupportApplyOneCellEOSExecutionContext::get_m_density)
    .def_property_readonly("internal_energy", &EosPerfectgas::PerfectGasAccWithSupportApplyOneCellEOSExecutionContext::get_m_internal_energy)
    .def_property_readonly("pressure", &EosPerfectgas::PerfectGasAccWithSupportApplyOneCellEOSExecutionContext::get_m_pressure)
    .def_property_readonly("sound_speed", &EosPerfectgas::PerfectGasAccWithSupportApplyOneCellEOSExecutionContext::get_m_sound_speed)
    .def_property_readonly("dpde", &EosPerfectgas::PerfectGasAccWithSupportApplyOneCellEOSExecutionContext::get_m_dpde)
