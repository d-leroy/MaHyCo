#ifndef EOS_PERFECTGAS___PERFECTGASPACCSERVICEVARS_H
#define EOS_PERFECTGAS___PERFECTGASPACCSERVICEVARS_H
...
struct PerfectGasPAccInitEOSVars final
{
  PerfectGasPAccInitEOSVars(const MaterialVariableCellReal& pressure,
...
struct PerfectGasPAccApplyEOSVars final
{
  PerfectGasPAccApplyEOSVars(const MaterialVariableCellReal& density,
...
struct PerfectGasPAccApplyOneCellEOSVars final
{
  PerfectGasPAccApplyOneCellEOSVars(const MaterialVariableCellReal& density,
      const MaterialVariableCellReal& internal_energy,
      MaterialVariableCellReal& pressure,
      MaterialVariableCellReal& sound_speed,
      MaterialVariableCellReal& dpde)
...
#endif  // EOS_PERFECTGAS___PERFECTGASPACCSERVICEVARS_H
