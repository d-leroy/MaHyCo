#ifndef EOS_PERFECTGAS___PERFECTGASNACCSERVICEVARS_H
#define EOS_PERFECTGAS___PERFECTGASNACCSERVICEVARS_H
...
struct PerfectGasNAccInitEOSVars final
{
  PerfectGasNAccInitEOSVars(const MaterialVariableCellReal& pressure,
...
struct PerfectGasNAccApplyEOSVars final
{
...
struct PerfectGasNAccApplyOneCellEOSVars final
{
  PerfectGasNAccApplyOneCellEOSVars(const MaterialVariableCellReal& density,
      const MaterialVariableCellReal& internal_energy,
      MaterialVariableCellReal& pressure,
      MaterialVariableCellReal& sound_speed,
      MaterialVariableCellReal& dpde)
...
#endif  // EOS_PERFECTGAS___PERFECTGASNACCSERVICEVARS_H
