#ifndef EOS_PERFECTGAS___PERFECTGASSERVICEVIEWS_H
#define EOS_PERFECTGAS___PERFECTGASSERVICEVIEWS_H
...
struct PerfectGasApplyEOSViews final
{
  PerfectGasApplyEOSViews(const ax::MatItemVariableScalarInViewT<Cell,Real>& density,
...
#endif  // EOS_PERFECTGAS___PERFECTGASSERVICEVIEWS_H
