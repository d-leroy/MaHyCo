...
#define SCIHOOK_TRIGGER_EOS_PERFECTGAS_PERFECTGAS_INITEOS_BEFORE \
...
#define SCIHOOK_TRIGGER_EOS_PERFECTGAS_PERFECTGAS_INITEOS_AFTER SciHook::trigger(INITEOS_AFTER, ctx);
#else
#define SCIHOOK_TRIGGER_EOS_PERFECTGAS_PERFECTGAS_INITEOS_BEFORE
#define SCIHOOK_TRIGGER_EOS_PERFECTGAS_PERFECTGAS_INITEOS_AFTER
#endif
...
#else
#define SCIHOOK_TRIGGER_EOS_PERFECTGAS_PERFECTGAS_APPLYEOS_BEFORE
#define SCIHOOK_TRIGGER_EOS_PERFECTGAS_PERFECTGAS_APPLYEOS_AFTER
#endif
...
#define SCIHOOK_TRIGGER_EOS_PERFECTGAS_PERFECTGAS_APPLYONECELLEOS_BEFORE \
...
#define SCIHOOK_TRIGGER_EOS_PERFECTGAS_PERFECTGAS_APPLYONECELLEOS_AFTER SciHook::trigger(APPLYONECELLEOS_AFTER, ctx);
#else
#define SCIHOOK_TRIGGER_EOS_PERFECTGAS_PERFECTGAS_APPLYONECELLEOS_BEFORE
#define SCIHOOK_TRIGGER_EOS_PERFECTGAS_PERFECTGAS_APPLYONECELLEOS_AFTER
#endif
