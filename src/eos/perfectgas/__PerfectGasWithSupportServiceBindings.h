...
void bind_eos_perfectgas_perfectgaswithsupport(py::module __attribute__((unused)) &m)
{
  ...
  pybind11::class_<EosPerfectgas::PerfectGasWithSupportApplyEOSWithSupportExecutionContext, std::shared_ptr<EosPerfectgas::PerfectGasWithSupportApplyEOSWithSupportExecutionContext>, SciHook::SciHookExecutionContext>(sub_eos_perfectgas_perfectgaswithsupport, "PerfectGasWithSupportApplyEOSWithSupportExecutionContext")
    ...
    .def_property_readonly("pressure", &EosPerfectgas::PerfectGasWithSupportApplyEOSWithSupportExecutionContext::get_pressure)
    .def_property_readonly("sound_speed", &EosPerfectgas::PerfectGasWithSupportApplyEOSWithSupportExecutionContext::get_sound_speed)
    .def_property_readonly("dpde", &EosPerfectgas::PerfectGasWithSupportApplyEOSWithSupportExecutionContext::get_dpde)
  ...
  pybind11::class_<EosPerfectgas::PerfectGasWithSupportInitEOSExecutionContext, std::shared_ptr<EosPerfectgas::PerfectGasWithSupportInitEOSExecutionContext>, SciHook::SciHookExecutionContext>(sub_eos_perfectgas_perfectgaswithsupport, "PerfectGasWithSupportInitEOSExecutionContext")
    ...
    .def_property_readonly("pressure", &EosPerfectgas::PerfectGasWithSupportInitEOSExecutionContext::get_pressure)
    .def_property_readonly("density", &EosPerfectgas::PerfectGasWithSupportInitEOSExecutionContext::get_density)
    .def_property_readonly("internal_energy", &EosPerfectgas::PerfectGasWithSupportInitEOSExecutionContext::get_internal_energy)
    .def_property_readonly("sound_speed", &EosPerfectgas::PerfectGasWithSupportInitEOSExecutionContext::get_sound_speed)
  ...
  pybind11::class_<EosPerfectgas::PerfectGasWithSupportApplyOneCellEOSExecutionContext, std::shared_ptr<EosPerfectgas::PerfectGasWithSupportApplyOneCellEOSExecutionContext>, SciHook::SciHookExecutionContext>(sub_eos_perfectgas_perfectgaswithsupport, "PerfectGasWithSupportApplyOneCellEOSExecutionContext")
    ...
    .def_property_readonly("density", &EosPerfectgas::PerfectGasWithSupportApplyOneCellEOSExecutionContext::get_density)
    .def_property_readonly("internal_energy", &EosPerfectgas::PerfectGasWithSupportApplyOneCellEOSExecutionContext::get_internal_energy)
    .def_property_readonly("pressure", &EosPerfectgas::PerfectGasWithSupportApplyOneCellEOSExecutionContext::get_pressure)
    .def_property_readonly("sound_speed", &EosPerfectgas::PerfectGasWithSupportApplyOneCellEOSExecutionContext::get_sound_speed)
    .def_property_readonly("dpde", &EosPerfectgas::PerfectGasWithSupportApplyOneCellEOSExecutionContext::get_dpde)
