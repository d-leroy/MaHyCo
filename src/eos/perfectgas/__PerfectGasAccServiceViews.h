#ifndef EOS_PERFECTGAS___PERFECTGASACCSERVICEVIEWS_H
#define EOS_PERFECTGAS___PERFECTGASACCSERVICEVIEWS_H
...
struct PerfectGasAccApplyEOSWithSupportViews final
{
  PerfectGasAccApplyEOSWithSupportViews(const ax::MatItemVariableScalarInViewT<Cell,Real>& density,
...
#endif  // EOS_PERFECTGAS___PERFECTGASACCSERVICEVIEWS_H
