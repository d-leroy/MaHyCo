...
void bind_eos_perfectgas_perfectgasnacc(py::module __attribute__((unused)) &m)
{
  ...
  pybind11::class_<EosPerfectgas::PerfectGasNAccInitEOSExecutionContext, std::shared_ptr<EosPerfectgas::PerfectGasNAccInitEOSExecutionContext>, SciHook::SciHookExecutionContext>(sub_eos_perfectgas_perfectgasnacc, "PerfectGasNAccInitEOSExecutionContext")
    ...
    .def_property_readonly("pressure", &EosPerfectgas::PerfectGasNAccInitEOSExecutionContext::get_m_pressure)
    .def_property_readonly("density", &EosPerfectgas::PerfectGasNAccInitEOSExecutionContext::get_m_density)
    .def_property_readonly("internal_energy", &EosPerfectgas::PerfectGasNAccInitEOSExecutionContext::get_m_internal_energy)
    .def_property_readonly("sound_speed", &EosPerfectgas::PerfectGasNAccInitEOSExecutionContext::get_m_sound_speed)
  ...
  pybind11::class_<EosPerfectgas::PerfectGasNAccApplyEOSExecutionContext, std::shared_ptr<EosPerfectgas::PerfectGasNAccApplyEOSExecutionContext>, SciHook::SciHookExecutionContext>(sub_eos_perfectgas_perfectgasnacc, "PerfectGasNAccApplyEOSExecutionContext")
    ...
    .def_property_readonly("density", &EosPerfectgas::PerfectGasNAccApplyEOSExecutionContext::get_m_density)
    .def_property_readonly("internal_energy", &EosPerfectgas::PerfectGasNAccApplyEOSExecutionContext::get_m_internal_energy)
    .def_property_readonly("pressure", &EosPerfectgas::PerfectGasNAccApplyEOSExecutionContext::get_m_pressure)
    .def_property_readonly("sound_speed", &EosPerfectgas::PerfectGasNAccApplyEOSExecutionContext::get_m_sound_speed)
    .def_property_readonly("dpde", &EosPerfectgas::PerfectGasNAccApplyEOSExecutionContext::get_m_dpde)
  ...
  pybind11::class_<EosPerfectgas::PerfectGasNAccApplyOneCellEOSExecutionContext, std::shared_ptr<EosPerfectgas::PerfectGasNAccApplyOneCellEOSExecutionContext>, SciHook::SciHookExecutionContext>(sub_eos_perfectgas_perfectgasnacc, "PerfectGasNAccApplyOneCellEOSExecutionContext")
    ...
    .def_property_readonly("density", &EosPerfectgas::PerfectGasNAccApplyOneCellEOSExecutionContext::get_m_density)
    .def_property_readonly("internal_energy", &EosPerfectgas::PerfectGasNAccApplyOneCellEOSExecutionContext::get_m_internal_energy)
    .def_property_readonly("pressure", &EosPerfectgas::PerfectGasNAccApplyOneCellEOSExecutionContext::get_m_pressure)
    .def_property_readonly("sound_speed", &EosPerfectgas::PerfectGasNAccApplyOneCellEOSExecutionContext::get_m_sound_speed)
    .def_property_readonly("dpde", &EosPerfectgas::PerfectGasNAccApplyOneCellEOSExecutionContext::get_m_dpde)
