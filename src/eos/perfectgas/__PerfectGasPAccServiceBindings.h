...
void bind_eos_perfectgas_perfectgaspacc(py::module __attribute__((unused)) &m)
{
  ...
  pybind11::class_<EosPerfectgas::PerfectGasPAccInitEOSExecutionContext, std::shared_ptr<EosPerfectgas::PerfectGasPAccInitEOSExecutionContext>, SciHook::SciHookExecutionContext>(sub_eos_perfectgas_perfectgaspacc, "PerfectGasPAccInitEOSExecutionContext")
    ...
    .def_property_readonly("pressure", &EosPerfectgas::PerfectGasPAccInitEOSExecutionContext::get_m_pressure)
    .def_property_readonly("density", &EosPerfectgas::PerfectGasPAccInitEOSExecutionContext::get_m_density)
    .def_property_readonly("internal_energy", &EosPerfectgas::PerfectGasPAccInitEOSExecutionContext::get_m_internal_energy)
    .def_property_readonly("sound_speed", &EosPerfectgas::PerfectGasPAccInitEOSExecutionContext::get_m_sound_speed)
  ...
  pybind11::class_<EosPerfectgas::PerfectGasPAccApplyEOSExecutionContext, std::shared_ptr<EosPerfectgas::PerfectGasPAccApplyEOSExecutionContext>, SciHook::SciHookExecutionContext>(sub_eos_perfectgas_perfectgaspacc, "PerfectGasPAccApplyEOSExecutionContext")
    ...
    .def_property_readonly("density", &EosPerfectgas::PerfectGasPAccApplyEOSExecutionContext::get_m_density)
    .def_property_readonly("internal_energy", &EosPerfectgas::PerfectGasPAccApplyEOSExecutionContext::get_m_internal_energy)
    .def_property_readonly("pressure", &EosPerfectgas::PerfectGasPAccApplyEOSExecutionContext::get_m_pressure)
    .def_property_readonly("sound_speed", &EosPerfectgas::PerfectGasPAccApplyEOSExecutionContext::get_m_sound_speed)
    .def_property_readonly("dpde", &EosPerfectgas::PerfectGasPAccApplyEOSExecutionContext::get_m_dpde)
  ...
  pybind11::class_<EosPerfectgas::PerfectGasPAccApplyOneCellEOSExecutionContext, std::shared_ptr<EosPerfectgas::PerfectGasPAccApplyOneCellEOSExecutionContext>, SciHook::SciHookExecutionContext>(sub_eos_perfectgas_perfectgaspacc, "PerfectGasPAccApplyOneCellEOSExecutionContext")
    ...
    .def_property_readonly("density", &EosPerfectgas::PerfectGasPAccApplyOneCellEOSExecutionContext::get_m_density)
    .def_property_readonly("internal_energy", &EosPerfectgas::PerfectGasPAccApplyOneCellEOSExecutionContext::get_m_internal_energy)
    .def_property_readonly("pressure", &EosPerfectgas::PerfectGasPAccApplyOneCellEOSExecutionContext::get_m_pressure)
    .def_property_readonly("sound_speed", &EosPerfectgas::PerfectGasPAccApplyOneCellEOSExecutionContext::get_m_sound_speed)
    .def_property_readonly("dpde", &EosPerfectgas::PerfectGasPAccApplyOneCellEOSExecutionContext::get_m_dpde)
