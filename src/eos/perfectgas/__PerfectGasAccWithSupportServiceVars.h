#ifndef EOS_PERFECTGAS___PERFECTGASACCWITHSUPPORTSERVICEVARS_H
#define EOS_PERFECTGAS___PERFECTGASACCWITHSUPPORTSERVICEVARS_H
...
struct PerfectGasAccWithSupportInitEOSVars final
{
  PerfectGasAccWithSupportInitEOSVars(const MaterialVariableCellReal& pressure,
...
struct PerfectGasAccWithSupportApplyEOSVars final
{
  PerfectGasAccWithSupportApplyEOSVars()
  {}
};

//! Classe de variable pour applyOneCellEOS
struct PerfectGasAccWithSupportApplyOneCellEOSVars final
{
  PerfectGasAccWithSupportApplyOneCellEOSVars(const MaterialVariableCellReal& density,
...
#endif  // EOS_PERFECTGAS___PERFECTGASACCWITHSUPPORTSERVICEVARS_H
