...
private:\
 ...
 size_t COMPUTEVARIABLESFORREMAP_PBORN0_BEFORE;\
 size_t COMPUTEVARIABLESFORREMAP_PBORN0_AFTER;\
...
COMPUTEVARIABLESFORREMAP_PBORN0_BEFORE = SciHook::register_base_event("Mahyco.ComputeVariablesForRemap_PBorn0.Before");\
COMPUTEVARIABLESFORREMAP_PBORN0_AFTER = SciHook::register_base_event("Mahyco.ComputeVariablesForRemap_PBorn0.After");\
...
#if defined(SCIHOOK_ENABLED) && not defined(SCIHOOK_MAHYCO_MAHYCO_DISABLED) && not defined(SCIHOOK_MAHYCO_MAHYCO_COMPUTEVARIABLESFORREMAP_PBORN0_DISABLED)
#define SCIHOOK_TRIGGER_COMPUTEVARIABLESFORREMAP_PBORN0_BEFORE \
std::shared_ptr<MahycoComputeVariablesForRemap_PBorn0ExecutionContext> ctx(new MahycoComputeVariablesForRemap_PBorn0ExecutionContext("ComputeVariablesForRemap_PBorn0ExecutionContext", &vars));\
SciHook::trigger(COMPUTEVARIABLESFORREMAP_PBORN0_BEFORE, ctx);
#define SCIHOOK_TRIGGER_COMPUTEVARIABLESFORREMAP_PBORN0_AFTER SciHook::trigger(COMPUTEVARIABLESFORREMAP_PBORN0_AFTER, ctx);
#else
#define SCIHOOK_TRIGGER_COMPUTEVARIABLESFORREMAP_PBORN0_BEFORE
#define SCIHOOK_TRIGGER_COMPUTEVARIABLESFORREMAP_PBORN0_AFTER
#endif
